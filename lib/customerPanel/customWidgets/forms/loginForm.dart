import 'package:findme/customerPanel/customWidgets/forms/registerForm.dart';
...
class CustomerLoginForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      child: Column(children: [customerLoginFormWidget(context)]),
    )));
  }
}
...
Widget customerLoginFormWidget(BuildContext context) {
